...
function ChildDetail({tab,setTab}:{tab:ChildTab;setTab:(x:ChildTab)=>void}){
  return <div className={`detail-layout child-detail child-${tab}`}>
    <div className="detail-title"><div className="eyebrow warm">03 · ФЛАГМАН 01</div><h2>{tab==="program"?<>Безопасный город <em>для детей</em></>:<>Безопасный<br/>город <em>для детей</em></>}</h2><p>Не медицинская кампания, а городская программа снижения числа первых травм.</p></div>
    <div className="detail-panel">
      ...
      {tab==="scale"&&<div className="child-situation child-scroll"><div className="section-lead"><b>Здоровье детей ухудшается, а травматизм стал самым тревожным трендом</b><span>Дети 0–14 лет · динамика 2016–2025</span></div><div className="situation-metrics"><article><b>2 617</b><span>общая заболеваемость на 1 000</span><em>Рост на 24,2% с 2016 года</em></article><article><b>2 409</b><span>первичная заболеваемость на 1 000</span><em>Рост на 22,6% с 2016 года</em></article><article><b>≈75%</b><span>болезни органов дыхания</span><em>С 1 445 до 1 801 на 1 000 детей</em></article><article className="critical"><b>265,4</b><span>травмы на 1 000 детей</span><em>В 8 раз выше уровня 2016 года</em></article></div><div className="trend-strip"><div><b>+133%</b><span>эндокринные болезни</span><small>8,3 на 1 000</small></div><div><b>+178%</b><span>ожирение</span><small>2,5 на 1 000</small></div><div><b>×2</b><span>бронхиальная астма</span><small>0,7 на 1 000</small></div><div><b>+30%</b><span>болезни нервной системы</span><small>10,9 на 1 000</small></div></div><div className="injury-story"><div className="injury-main"><b>1 300 → 8 391</b><span>случаев детского травматизма</span><p>Ускорение началось с 2021 года; наиболее резкий скачок пришёлся на 2022–2023 годы.</p></div><div><b>192,7 / 109,9</b><span>случаев травм на 1 000 детей · Южно‑Сахалинск / Россия</span><p>Сравнение за 2023 год: городской уровень почти вдвое выше среднероссийского.</p></div><div><b>3 810</b><span>падений · 45% случаев</span><p>Транспортные травмы выросли с 7 случаев в 2020 году до 101 в 2025-м.</p></div></div></div>}
