  ...
  return <div className={`detail-layout child-detail child-${tab}`}>
    ...
    <div className="detail-panel">
      ...
      {tab==="scale"&&<div className="child-situation child-scroll">
        ...
        <div className="injury-story"><div className="injury-main"><b>1 300 → 8 391</b><span>случаев детского травматизма</span><p>Ускорение началось с 2021 года; наиболее резкий скачок пришёлся на 2022–2023 годы.</p></div><div><b>192,7 / 109,9</b><span>случаев травм на 1 000 детей · Южно‑Сахалинск / Россия</span><p>Сравнение за 2023 год: городской уровень почти вдвое выше среднероссийского.</p></div><div><b>3 810</b><span>случаев падений среди детей в 2025 году</span><p>Это около 45% всего детского травматизма. Отдельный тревожный тренд — транспортные травмы: с 7 случаев в 2020 году до 101 в 2025 году, то есть рост более чем в 14 раз.</p></div></div>
      </div>}
