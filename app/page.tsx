...
function Balance({mode,setMode}:{mode:BalanceMode;setMode:(x:BalanceMode)=>void}){
  ...
  return <div className={`balance-layout ${mode}`}>
    <div className="balance-head"><div className="eyebrow">01 · ПОРТРЕТ ГОРОДА · 2016–2025</div><h2>Южно‑Сахалинск сегодня.<br/><em>Сильные стороны<br/>и направления для роста.</em></h2></div>
